...
(ert-deftest docopt-test-eval-naval-fate ()
  (let ((program (docopt-parse-program docopt-naval-fate-str)))
    (should (equal '((--drifting)
                     ...
                     (ship)
                     (shoot))
                   (docopt-eval program "naval_fate mine set 1 2 --moored")))

    (should (equal '((--drifting . t)
                     (--help)
                     (--moored)
                     (--speed . "10")
                     (--version)
                     ...
                     (ship)
                     (shoot))
                   (docopt-eval program "naval_fate mine set 1 2 --drifting")))
    ...
    (should (equal '((--drifting)
                     ...
                     (ship)
                     (shoot))
                   (docopt-eval program "naval_fate mine set 1 2")))
    ...
    (should (equal '((--drifting)
                     ...
                     (ship . t)
                     (shoot))
                   (docopt-eval program "naval_fate ship new TITANIC")))
    ...
    ;;                  (ship . t)
    ;;                  (shoot))
    ;;                (docopt-eval program "naval_fate ship SHIP-123 move 1 2 --speed=20")))
    ))
